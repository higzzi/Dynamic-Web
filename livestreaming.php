...
<head>
    ...
    <title>Livestreaming - Social Media Safety Campaign</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <section class="container mt-5">
        <div class="transparent-box">
            ...
            <div class="row align-items-center mt-5">
                <div class="col-md-6 text-md-start">
                    <h3>What is Livestreaming?</h3>
                    <p>Livestreaming is the broadcasting of real-time video content over the internet. It allows users
                        to share live events, performances, or personal moments with an audience in real-time.</p>
                </div>
                <div class="col-md-6 text-center">
                    <div class="image-container">
                        <img src="Images/live1.png" alt="Livestreaming Image" class="img-fluid rounded-4">
                        <div class="pt-3">
                            <p>Livestreaming</p>
                        </div>
                    </div>
                ...
                <div class="row align-items-center mt-5">
                    <div class="col-md-6 text-md-start order-md-last">
                        <h3>How to Livestream Safely</h3>
                        <p>To ensure a safe livestreaming experience, consider the following tips:</p>
                        <ul>
                            <li>Choose a secure platform: Select a reputable and secure livestreaming platform that
                                prioritizes user privacy and safety.</li>
                            <li>Set privacy settings: Adjust privacy settings to control who can view your livestream.
                                Consider making your livestream private or limiting it to a select group of viewers.
                            </li>
                            <li>Be mindful of personal information: Avoid sharing sensitive personal information, such
                                as your location, address, or phone number, during a livestream.</li>
                            <li>Interact responsibly: Engage with viewers in a respectful and responsible manner.
                                Monitor comments and interactions to ensure a positive and safe environment.</li>
                            <li>Protect against cyberbullying: Be aware of the risk of cyberbullying during livestreams.
                                Take immediate action to block or report any abusive or inappropriate behavior from
                                viewers.</li>
                            <li>End stream if necessary: If you encounter any safety concerns or uncomfortable
                                situations during a livestream, don't hesitate to end the stream immediately.</li>
                            <li>Seek support: Reach out to trusted friends, family members, or moderators for support
                                and guidance if you feel unsafe or overwhelmed during a livestream.</li>
                        </ul>
                    </div>
                    <div class="col-md-6 text-center order-md-first rounded-3">
                        <video id="video-player" class="rounded-5 w-100 h-auto " controls>
                            <source src="video/live.mp4" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                        <div class="pt-3">
                            <p>Livestreaming Tips Video</p>
                        </div>
                    </div>
                </div>
        ...
        <footer class="mt-5 text-center">
            ...
            <p class="mt-3" id="youAreHereCounter">You are here: (Livestreaming)</p>
