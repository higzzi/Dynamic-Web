...
<head>
    ...
    <title>Information - Social Media Safety Campaign</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <section class="container mt-5">
        <div class="transparent-box">
            ...
            <p>The social media safety campaign is aimed at raising awareness among teenagers about the potential risks
                and dangers of using social media platforms. The campaign focuses on educating teenagers about safe
                online behavior and providing resources and support to help them navigate the digital world responsibly.
            </p>

            <h3>Aims and Vision</h3>
            <p>The main aims and vision of the social media safety campaign include:</p>
            <ul>
                <li>Empowering teenagers to make informed decisions about their online activities.</li>
                <li>Teaching teenagers how to protect their personal information and privacy online.</li>
                <li>Encouraging positive online behavior, including kindness, respect, and empathy.</li>
                <li>Providing resources and support for teenagers who may be experiencing cyberbullying or online
                    harassment.</li>
                <li>Collaborating with parents, educators, and other stakeholders to create a safer online environment
                    for teenagers.</li>
            </ul>
            ...
            <div class="row">
                <div class="col-md-6 text-center">
                    <div class="image-container">
                        <img src="Images/smc2.png" alt="Social Media Campaign"
                            class=" img-fluid rounded-4 w-75 h-auto ">
                        <div class="pt-3">
                            <p>SocialMediaCampaign</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 text-center">
                    <div class="image-container">
                        <img src="Images/Onlinesafety.jpg" alt="Online Safety" class="img-fluid rounded-4 h-auto  w-75">
                        <div class="pt-3 ">
                            <p>Onlinesafety</p>
                        </div>
                    </div>
        ...
        <footer class="mt-5 text-center">
            ...
            <p class="mt-3" id="youAreHereCounter">You are here: (Infromation)</p>
