...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown1">
                                ...
                                <li><a class="dropdown-item text-light" href="legislation.php">Legislation
                                        and Guidance</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
    ...
    <div class="container mt-5">
            ...
            <section class="mt-5">
                <div class="row justify-content-center">
                    <div class="col-md-8" style="color: white;">
                        ...
                        <p>Stay up-to-date with the latest news, tips, and updates on social media safety. Our monthly
                            newsletter covers a wide range of topics, including:</p>
                        <ul>
                            <li>Safety tips for parents and children</li>
                            <li>Guidance on navigating popular social media apps</li>
                            <li>Legislation updates related to online safety</li>
                            <li>Exclusive offers and promotions</li>
                            <li>And much more!</li>
                        </ul>
                        <p>Signing up is quick, easy, and free! Simply enter your email address below to subscribe:</p>
                    </div>
                </div>
                <form action="success.php" method="post">
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            ...
                            <!-- Submit button -->
                            <button type="submit" name="submit" id="submit" class="btn btn-primary pt=3">Sign Up</button>
                        </div>
        ...
        <footer class="mt-5 text-center">
            ...
            <p class="mt-3" id="youAreHereCounter">You are here: (Newsletter)</p>
